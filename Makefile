...
pkgdatadir = $(datadir)/sw
pkgincludedir = $(includedir)/sw
pkglibdir = $(libdir)/sw
pkglibexecdir = $(libexecdir)/sw
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/README.md.in \
	$(srcdir)/SECURITY.md.in $(top_srcdir)/build-aux/compile \
	$(top_srcdir)/build-aux/install-sh \
	$(top_srcdir)/build-aux/missing \
	$(top_srcdir)/build-aux/tap-driver.sh \
	$(top_srcdir)/docsx/Doxyfile.in build-aux/compile \
...
ACLOCAL = ${SHELL} '/usr/local/src/sw/build-aux/missing' aclocal-1.16
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/usr/local/src/sw/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/usr/local/src/sw/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/usr/local/src/sw/build-aux/missing' automake-1.16
AWK = mawk
...
LIBOBJS =  ${LIBOBJDIR}lstat$U.o ${LIBOBJDIR}malloc$U.o ${LIBOBJDIR}realloc$U.o
LIBS = 
LTLIBOBJS =  ${LIBOBJDIR}lstat$U.lo ${LIBOBJDIR}malloc$U.lo ${LIBOBJDIR}realloc$U.lo
MAKEINFO = ${SHELL} '/usr/local/src/sw/build-aux/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = sw
PACKAGE_BUGREPORT = sw@twyoung.com
PACKAGE_NAME = sw
PACKAGE_STRING = sw 0.27.1
PACKAGE_TARNAME = sw
PACKAGE_URL = 
...
abs_top_srcdir = /usr/local/src/sw
ac_ct_CC = 
ac_ct_CXX = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /usr/local/src/sw/build-aux/install-sh
