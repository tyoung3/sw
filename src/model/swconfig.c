...
struct cfg_ cfg = { 0, 10000, 10000, 1000, 
	"def", "defaulType", "Gen", "Print", "Filter", 
	"defaultOrphanComp", "defaultLib", 
	"/home/tyoung3/go/src/github.com/tyoung3/sw/lib", "/home/tyoung3/go/src/github.com/tyoung3/sw/html/","_" };
