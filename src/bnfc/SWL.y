...
%token _SYMB_14    /*   ---   */
%token _SYMB_15    /*   :   */
%token _SYMB_16    /*   ATTRIBUTES   */
%token _SYMB_17    /*   INCLUDE   */
%token _SYMB_18    /*   PREFIX   */
%token _SYMB_19    /*   include   */
%token _SYMB_20    /*   prefix   */
%token<string_> _SYMB_21    /*   Numvar   */
%token<string_> _SYMB_22    /*   Stringvar   */
%token<string_> _SYMB_23    /*   Envar   */
%token<string_> _SYMB_24    /*   Symvar   */
%token<string_> _SYMB_25    /*   SubId   */
%token<string_> _SYMB_26    /*   Id   */
%token<string_> _SYMB_27    /*   ValidImport   */
%token<string_> _SYMB_28    /*   Date   */
...
;
Subdef : _SYMB_25 _SYMB_1 ListSubnet _SYMB_2 { $$ = make_Snet($1, reverseListSubnet($3));  }
;
...
;
Proc : _SYMB_8 Symvalu Comp ListArgument Attributes _SYMB_9 { $$ = make_Processx($2, $3, reverseListArgument($4), $5);  }
  | _SYMB_8 Symvalu Attributes _SYMB_9 { $$ = make_Processy($2, $3);  }
;
Attributes : _SYMB_16 _SYMB_1 ListAttr _SYMB_2 { $$ = make_Attribe($3);  }
  | /* empty */ { $$ = make_Attribs();  }
;
Attr : Symval _SYMB_10 Stringval { $$ = make_Attrs($1, $3);  }
  | Symval _SYMB_10 Numval { $$ = make_Attrn($1, $3);  }
;
ListAttr : /* empty */ { $$ = 0;  }
  | Attr { $$ = make_ListAttr($1, 0);  }
  | Attr _SYMB_6 ListAttr { $$ = make_ListAttr($1, $3);  }
;
...
ModPath : _SYMB_12 Symval _SYMB_12 { $$ = make_Modpa($2);  }
  ...
  | _SYMB_22 _SYMB_12 { $$ = make_Modps($1);  }
;
RemPath : _SYMB_27 _SYMB_11 Symval { $$ = make_RemPatha($1, $3);  }
;
...
;
Numassgn : _SYMB_21 _SYMB_10 Numval { $$ = make_NumAssgnv($1, $3);  }
;
Strassgn : _SYMB_22 _SYMB_10 Stringval { $$ = make_StrAssgnv($1, $3);  }
;
SymAssgn : _SYMB_24 _SYMB_10 Symval { $$ = make_SymAssgni($1, $3);  }
;
Numval : _INTEGER_ { $$ = make_NumVali($1);  }
  | _SYMB_21 { $$ = make_NumValv($1);  }
;
Stringval : _STRING_ { $$ = make_StringVals($1);  }
  | _SYMB_22 { $$ = make_StringValv($1);  }
  | _SYMB_23 { $$ = make_StringVale($1);  }
;
Symval : _SYMB_24 { $$ = make_Symvalv($1);  }
  | _SYMB_26 { $$ = make_Symvali($1);  }
  | _SYMB_23 { $$ = make_SymVale($1);  }
;
Include : _SYMB_19 { $$ = make_Inc1();  }
  | _SYMB_17 { $$ = make_Inc2();  }
;
Prefix : _SYMB_18 { $$ = make_Prefu();  }
  | _SYMB_20 { $$ = make_Prefl();  }
;
...
KeyVal : KeyName _INTEGER_ { $$ = make_CfgKeyvalint($1, $2);  }
  ...
  | KeyName _SYMB_28 { $$ = make_CfgKeyDate($1, $2);  }
;
