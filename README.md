...
### Installation   
  ...
  * Download the latest sw-0.21.0.tar.gz file 
	  from https://github.com/tyoung3/sw/build
  * Run 'tar -xzf .../sw-0.21.0.tar.gz' to extract source files
  * cd  sw-0.21.0
...
![a graphic image of loadbal.sw](docs/images/loadbal.svg)
and (on console)
