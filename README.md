...
### Installation<a name="installation"/>   
  ...
  * Download the latest sw-0.27.0.tar.gz file 
	  from https://github.com/tyoung3/sw/build
  * Run 'tar -xzf .../sw-0.27.0.tar.gz' to extract source files
  * cd  sw-0.27.0
...
#### Semi-colon commentary<a name="semicolons"/>
