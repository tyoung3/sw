...
(C std.Collate  ) 			  <- (IV_MO    std.Gen1 "108" "910" "17" );
(C)1 	     	    		  <- (XIX_MO   std.Gen1 "140" "919" "13" );
...
#              Partition II 
(C2 std.Collate  ) 		  	 <- (X_WASH  std.Gen1 "108" "916" "17" );
(C2)1 	     	          	 <- (XIX2_MO std.Gen1 "140" "919" "13" );
...
(C3 std.Collate) 	 		 <- (QQ        std.Gen1 "140" "914" "13" );
(C3)1	 	 				 <- (VIII_OHIO std.Gen1 "108" "914" "17" );
