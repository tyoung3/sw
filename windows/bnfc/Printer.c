...
void ppListStm(ListStm liststm, int i)
{
  ...
  { /* cons */
    ppStm(liststm->stm_, 0);
    renderC(';');
    ppListStm(liststm->liststm_, 0);
  }
}
...
void ppListSubnet(ListSubnet listsubnet, int i)
{
  ...
  { /* cons */
    ppSubnet(listsubnet->subnet_, 0);
    renderC(';');
    ppListSubnet(listsubnet->listsubnet_, 0);
  }
}
...
void ppListArgument(ListArgument listargument, int i)
{
  ...
  { /* cons */
    ppArgument(listargument->argument_, 0);
    ppListArgument(listargument->listargument_, 0);
  }
}
...
void ppListCentry(ListCentry listcentry, int i)
{
  ...
  { /* cons */
    ppCentry(listcentry->centry_, 0);
    renderC(',');
    ppListCentry(listcentry->listcentry_, 0);
  }
}
...
void ppListEntry(ListEntry listentry, int i)
{
  ...
  { /* cons */
    ppEntry(listentry->entry_, 0);
    ppListEntry(listentry->listentry_, 0);
  }
}
