...
(MISSOURI_IV strings.Print1)0 <- 2(C);
(MO_XIX      strings.Print1)0 <- 3(C);
...
(WASH_X      strings.Print1)0 <- 2(C2);
(MATCH_XIX_2  strings.Print1)0 <- 3(C2);
(MISS_X      strings.Print1)0 <- 4(C2);
(MISS_XIX_2  strings.Print1)0 <- 5(C2);
...
(OHIO_VIII strings.Print1)0 <- 2(C3);
(MATCH_QQ strings.Print1)0  <- 3(C3);
(MISS_VIII strings.Print1)0 <- 4(C3);
(MISS_QQ  strings.Print1)0  <- 5(C3);
