...
func NewQString() *QString {
	return &QString{list.New()}
}
// QString is a queue implementation for the string type.
...
func (q *QString) Len() int {
	return q.list.Len()
}
// Enqueue adds an item to the back of the queue
func (q *QString) Enqueue(i string) {
	q.list.PushBack(i)
}
// Dequeue removes and returns the front item in the queue
func (q *QString) Dequeue() string {
	if q.list.Len() == 0 {
